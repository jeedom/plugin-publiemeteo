...
<form class="form-horizontal">
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-lg-5">
				<a class="btn btn-success" id="bt_resetkey"><i class="fas fa-refresh"></i> {{Reset}}</a> {{Il sera nécessaire de reconfigurer les URLs sur les sites Internet.}}
			</div>
		</div>
	</fieldset>
</form>
				...
				$.ajax({ // fonction permettant de faire de l'ajax
					...
					success: function(data) { // si l'appel a bien fonctionné
						if (data.state != 'ok') {
							...
							$('#div_ResetKeyResult').showAlert({
								message: '{{Mise a jour de clef API OK}}',
								level: 'success'
							});
						}
					}
